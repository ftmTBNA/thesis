    ...
    for m in range(len(number_of_IOT)):
        ...
        for counter in range(Counter):
            ...
            if (counter+1) % 5 == 0:
                ...
                BEmobile.write(" %d\r\n")
                BEmobile.write(" ---number --- "+str(counter+1) +
                               " --------------------- ")
                BEmobile.write(" ---Time --- "+str(current_time) +
                               " --------------------- ")
                BEmobile.write(" ---SUM RATE --- " +
                               str(sum(SumRateList)/(counter+1))+" --- ")
                BEmobile.write(" ---FAIRNESS --- " +
